\ifdefined\english
    ...
    \begin{itemize}
        \item \textbf{GPA}: 4.41/5 (Top 15\% in Mixed Class, Top 10\% in Computer Science)
              % \item \textbf{Major Courses}: C Programming (4.8/5), Special Topics in C Programming (5/5), Object-Oriented
              %       Programming (5/5), Digital Logic Design (5/5), Computer Organization (5/5), Computer Architecture
              %       (4.8/5), Operating Systems (5/5), Network Security Principles and Practice (5/5), Software Security (5/5)
              % \item \textbf{Awards}: Third Prize in Zhejiang Province Mathematics Competition, Third Prize in Zhejiang
              %       Province College Physics Innovation Competition, Zhejiang University Third-Class Scholarship (3 times)
              % \item \textbf{Honors}: Chu Kochen Honors College Certificate, Zhejiang University Outstanding Graduate,
              %       Zhejiang University Outstanding Graduation Thesis
    \end{itemize}
