...
\else
    ...
    \ifdefined\qr\else
        ...
        % \noindent\textbf{智能医疗问诊平台~\footnote{\url{https://github.com/futuretech6/software-engineering-backend}} \textbar{} 课程项目 \textbar{} 账号管理模块后端负责人 (2021.03 - 2021.07)} % \hfill Go, GORM, Echo, Jwt-Go, SwagGo
